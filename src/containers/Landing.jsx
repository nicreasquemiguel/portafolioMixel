...
const Landing = () => {
  return (
    <section id='landing' className='  h-dvh snap-start snap-always grid min-h-[600px]  items-center text-center '>
        ...
        <div className='bg-red-700 h-full  text-center  dark:bg-black bg-blend-overlay dark:bg-blend-multiply bg-cover  grid place-content-center p-10'>
            ...
            <p className='font-madami xs:px-1 sm:px-32 text-white xs:text-lg sm:text-xl drop-shadow-[0px_-2px_0px_var(--tw-shadow-color)] shadow-black'> 
